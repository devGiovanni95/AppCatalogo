...
export default function Home() {
    ...
    return(
            <ScrollView >
                ...
                <ImageOverlayComponent imageUrl={imageUrl} legend={"Venha Conhecer nossos produtos"} onClick={() => router.push('/portfolio')}/>
                <Title title={'Outros Tópicos'}></Title>
                <ContainerImageText imageUrl={imageUrl1} text={'Como decidir o melhor aroma?'}/>
                <ContainerImageText imageUrl={imageUrl1} text={'Conheça nosso portfólio!'} onClick={() => router.push('/portfolio')}/>
